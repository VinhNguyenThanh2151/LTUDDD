...
private fun OnBoardingScreenHeader(
    ...
    Column(
        ...
        Icon(
            imageVector = ImageVector.vectorResource(id = com.example.run_core.R.drawable.img_login_1),
...
private fun FirstPage(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text(text = ShareUtils.getString("USER_NAME")!!)
            },
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(modifier = Modifier.size(16.dp))
